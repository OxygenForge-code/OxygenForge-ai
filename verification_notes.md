...
## Yeni ferah referans arayüzü final QA (1.5.0)

Ana sohbet, paylaşılan yeni referansın ferah siyah düzenine uyarlandı. Üst alanda düz çalışma adı ve açılır ok, solda sade menü kontrolü, sağda ışıltı/komut merkezi kontrolü bulunur. Boş durum, geniş siyah nefes alanında küçük renk geçişli OxygenForge simgesi ve `Hangi konuda ilgili yardımcı olabilirim?` karşılama metnini gösterir. Alt bölüm, referanstaki büyük koyu kapsül oluşturucuyu ve mavi ses/gönderme aksiyonunu korur; çalışma modu ve dosya bağlamı kapsülleri yalnızca gerektiğinde görünür.
